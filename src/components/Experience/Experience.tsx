...
const experiences: ExperienceItem[] = [
  {
    ...
    period: '2023 – 2024',
    description:
      'Stock management, order preparation, supplier coordination, and database maintenance.',
  },
  {
  ...
  return (
    <section id="experience" className="py-20 reveal">
      <div className="max-w-2xl mx-auto px-6">
        ...
        <ol className="relative list-none" style={{ borderLeft: '1px solid rgba(255,255,255,0.07)' }}>
            ...
            <li key={i} className="relative pl-10 pb-12 last:pb-0">
              ...
              >
                <div className="flex items-start justify-between gap-4 mb-1">
                  <div>
                    <p className="text-xs font-medium mb-1" style={{ color: 'rgba(129,140,248,0.7)', letterSpacing: '0.05em' }}>
                      {exp.company}
                    </p>
                    <h3 className="text-base font-semibold leading-snug">{exp.role}</h3>
                  </div>
                  <span
